...
def main(args):
    ...
    pi = 3.1416
    rest = [0.0, -0.34770231192074535, 0.03579288505066496, 0.0030679615757712823, -0.7465373167710121, 0, -0.0051132692929521375]
    mid = [0.0, 0.10737865515199489, 0.14317154020265985, -0.21475731030398976, -0.4755340442445488, 0, 0.0]
    final = [0.3170226961630325, 0.5777994301035916, 0.22498384888989406, -0.2684466378799872, -0.3681553890925539, 0.3, 0.0]

    desired_pose = rest
    cocontraction = [0.6, 0.6, 0.85, 0.6, 1.0, 0.6, 1.0]
